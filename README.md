...
# Mars Phoenix (phoenix:) Mission Dictionary
<!-- EXAMPLES
   Spectral (sp:) Discipline Dictionary
   DART Mission (dart:) Local Dictionary
-->

The Mars Phoenix mission dictionary provides classes and attributes specific to the Mars Phoenix mission and its instruments.
...
-->     
* Download dictionary files from [PHOENIX](https://pds.nasa.gov/datastandards/dictionaries/#phoenix)
